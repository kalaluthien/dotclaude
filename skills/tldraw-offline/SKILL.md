...
```bash
PORT=$(jq -r .port '/Users/hyungmokim/Library/Application Support/tldraw/server.json'); TOKEN=$(jq -r .token '/Users/hyungmokim/Library/Application Support/tldraw/server.json')
