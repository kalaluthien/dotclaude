...
## Claude Code
1. A project's instructions live in `PROJECT/AGENTS.md`; `PROJECT/.claude/CLAUDE.md` holds only `@../AGENTS.md` — one source every harness reads, and the `..` is required because an import resolves against the importing file.
